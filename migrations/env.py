...
from config import DB_SERVICE, DB_USERNAME, DB_PASSWORD, DB_HOST, DB_NAME
...
# Interpolation is supported in the file name, so we can also specify
# a filename relative to the config file.
